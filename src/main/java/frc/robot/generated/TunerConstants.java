...
private static final Pigeon2Configuration pigeonConfigs =
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0);//0.358398);//-0.047607);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0);//0.07251);//0.170166);
